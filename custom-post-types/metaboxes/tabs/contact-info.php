<div class="dtdr-custom-box">
    ...
    <input name="dtdr_email" type="text" value="<?php echo esc_attr( $dtdr_email );?>" />
...
<div class="dtdr-custom-box">
    ...
    <input name="dtdr_phone" type="text" value="<?php echo esc_attr( $dtdr_phone );?>" />
...
<div class="dtdr-custom-box">
    ...
    <input name="dtdr_mobile" type="text" value="<?php echo esc_attr( $dtdr_mobile );?>" />
...
<div class="dtdr-custom-box">
    ...
    <input name="dtdr_skype" type="text" value="<?php echo esc_attr( $dtdr_skype );?>" />
...
<div class="dtdr-custom-box">
    ...
    <input name="dtdr_website" type="text" value="<?php echo esc_attr( $dtdr_website );?>" />
