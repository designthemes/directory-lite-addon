...
<div class="dtdr-custom-box">
    ...
    <input name="dtdr_mls_number" type="text" value="<?php echo $dtdr_mls_number;?>" class="dtdr-mls-number" style="text-transform:uppercase" />
...
if((int)$author_id == (int)$user_id) {
    ...
    <div class="dtdr-custom-box">
        ...
        ?>
        <div data-for="dtdr_featured_item" class="dtdr-checkbox-switch <?php echo $switchclass;?>"></div>
        <input id="dtdr_featured_item" class="hidden" type="checkbox" name="dtdr_featured_item" value="true" <?php echo $checked;?> />
...
<div class="dtdr-custom-box">
    ...
    <input name="dtdr_excerpt_title" type="text" value="<?php echo $dtdr_excerpt_title;?>" class="dtdr-except-title" />    
