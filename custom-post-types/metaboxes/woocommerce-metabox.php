...
<div class="custom-box">
	<div class="column one-sixth">
		<label><?php echo esc_html__('Regular price','dtdr-lite'). ' (' . get_woocommerce_currency_symbol() . ')'; ?></label>
	</div>
...
<div class="custom-box">
	<div class="column one-sixth">
		<label><?php echo esc_html__('Sale price','dtdr-lite'). ' (' . get_woocommerce_currency_symbol() . ')'; ?></label>
	</div>
	<div class="column five-sixth last">
