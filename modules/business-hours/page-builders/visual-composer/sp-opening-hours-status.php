<?php
add_action( 'vc_before_init', 'dtdr_sp_opening_hours_status_vc_map' );

function dtdr_sp_opening_hours_status_vc_map() {

	$listing_singular_label = apply_filters( 'listing_label', 'singular' );

	vc_map( array(
		"name" => esc_html__( 'Opening Hours - Status','dtdr-lite'),
		"base" => "dtdr_sp_opening_hours_status",
		"icon" => "dtdr_sp_opening_hours_status",
