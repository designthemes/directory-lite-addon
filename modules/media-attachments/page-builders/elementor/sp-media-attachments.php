...
class DTDirectoryLiteSpMediaAttachments extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Media - Attachments','dtdr-lite');
	}
	...
	protected function render() {
		...
		$output = do_shortcode('[dtdr_sp_media_attachments '.$attributes.' /]');
