...
<div class="dtdr-custom-box">
    ...
    <input name="dtdr_currency_symbol" type="text" value="<?php echo $dtdr_currency_symbol;?>" />
...
<div class="dtdr-custom-box">
    ...
    <select name="dtdr_currency_symbol_position" class="dtdr-chosen-select">
        ...
        foreach($currency_symbol_positions as $currency_symbol_position_key => $currency_symbol_position_item) {
            echo '<option value="'.$currency_symbol_position_key.'" '.selected($currency_symbol_position_key, $dtdr_currency_symbol_position, false ).'>';
                echo $currency_symbol_position_item;
            echo '</option>';
        }
        ?>
    </select>
...
<div class="dtdr-custom-box">
    ...
    <input name="_regular_price" id="_regular_price" type="text" value="<?php echo $_regular_price;?>" />
...
<div class="dtdr-custom-box">
    ...
    <input name="_sale_price" id="_sale_price" type="text" value="<?php echo $_sale_price;?>" />
...
<div class="dtdr-custom-box">
    ...
    <input name="dtdr_before_price_label" type="text" value="<?php echo $dtdr_before_price_label;?>" />
...
<div class="dtdr-custom-box">
    ...
    <input name="dtdr_after_price_label" type="text" value="<?php echo $dtdr_after_price_label;?>" />
