<?php
add_action( 'vc_before_init', 'dtdr_sp_add_to_cart_vc_map' );

function dtdr_sp_add_to_cart_vc_map() {

	$listing_singular_label = apply_filters( 'listing_label', 'singular' );

	vc_map( array(
		"name"     => esc_html__( 'Add To Cart','dtdr-lite'),
		"base"     => "dtdr_sp_add_to_cart",
		"icon"     => "dtdr_sp_add_to_cart",
