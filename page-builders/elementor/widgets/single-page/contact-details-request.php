...
class DTDirectoryLiteSpContactDetailsRequest extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Contact Details - Send Request Button','dtdr-lite');
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section( 'features_default_section', array(
			...
			$this->add_control( 'button_label', array(
				'label'   => esc_html__( 'Button Label','dtdr-lite'),
				'type'    => Controls_Manager::TEXT,
	...
	protected function render() {
		...
		$output = do_shortcode('[dtdr_sp_contact_details_request_btn '.$attributes.' /]');
