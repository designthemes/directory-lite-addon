...
class DTDirectoryLiteSpFloorPlan extends Widget_Base {
	...
	public function get_name() {
		return 'dtdr-widget-sp-floor-plan';
	}

	public function get_title() {
		return esc_html__( 'Floor Plan','dtdr-lite');
	}

	public function get_style_depends() {
		$file_handlers =  dtdr_dependent_files_instance()->dtdr_single_page_module_files( 'dtdr_sp_floor_plan' );
	...
	protected function render() {
		...
		$output = do_shortcode('[dtdr_sp_floor_plan '.$attributes.' /]');
