...
class DTDirectoryLiteSpMlsNumber extends Widget_Base {
	...
	public function get_name() {
		return 'dtdr-widget-sp-mls-number';
	}

	public function get_title() {
		return esc_html__( 'MLS Number','dtdr-lite');
	}
	...
	protected function render() {
		...
		$output = do_shortcode('[dtdr_sp_mls_number '.$attributes.' /]');
