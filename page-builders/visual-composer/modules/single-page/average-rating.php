...
function dtdr_sp_average_rating_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( 'Average Rating','dtdr-lite'),
		...
		"params" => array(
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Display','dtdr-lite'),
				'param_name' => 'display',
				'value' => array(
					esc_html__('Both','dtdr-lite') => 'both',
					esc_html__('Star Rating','dtdr-lite') => 'star-rating',
					esc_html__('Overall Rating','dtdr-lite') => 'overall-rating',
				),
