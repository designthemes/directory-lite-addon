...
function dtdr_sp_floor_plan_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( 'Floor Plan','dtdr-lite'),
		...
		"params" => array(
			...
			array(
				...
				'description' => sprintf( esc_html__('Provide %1$s id for which you have to display floor plan. No need to provide ID if it is used in %1$s single page.','dtdr-lite'), strtolower($listing_singular_label) ),
