	...
	$output .= '<form name="formOptionSettings" class="formOptionSettings" method="post">';	
		...
		$output .= '<div class="dtdr-settings-options-holder">';
			...
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="listing-singular-label" name="dtdr[label][listing-singular-label]" type="text" value="'.esc_attr( $listing_singular_label ).'" />';
		...
		$output .= '<div class="dtdr-settings-options-holder">';
			...
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="listing-plural-label" name="dtdr[label][listing-plural-label]" type="text" value="'.esc_attr( $listing_plural_label ).'" />';
		...
		$output .= '<div class="dtdr-settings-options-holder">';
			...
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="contracttype-singular-label" name="dtdr[label][contracttype-singular-label]" type="text" value="'.esc_attr( $contracttype_singular_label ).'" />';
		...
		$output .= '<div class="dtdr-settings-options-holder">';
			...
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="contracttype-plural-label" name="dtdr[label][contracttype-plural-label]" type="text" value="'.esc_attr( $contracttype_plural_label ).'" />';
		...
		$output .= '<div class="dtdr-settings-options-holder">';
			...
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="amenity-singular-label" name="dtdr[label][amenity-singular-label]" type="text" value="'.esc_attr( $amenity_singular_label ).'" />';
		...
		$output .= '<div class="dtdr-settings-options-holder">';
			...
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="amenity-plural-label" name="dtdr[label][amenity-plural-label]" type="text" value="'.esc_attr( $amenity_plural_label ).'" />';
		...
		$output .= '<div class="dtdr-settings-options-holder">';
			...
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="seller-singular-label" name="dtdr[label][seller-singular-label]" type="text" value="'.esc_attr( $seller_singular_label ).'" />';
		...
		$output .= '<div class="dtdr-settings-options-holder">';
			...
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="seller-plural-label" name="dtdr[label][seller-plural-label]" type="text" value="'.esc_attr( $seller_plural_label ).'" />';
		...
		$output .= '<div class="dtdr-settings-options-holder">';
			...
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="incharge-singular-label" name="dtdr[label][incharge-singular-label]" type="text" value="'.esc_attr( $incharge_singular_label ).'" />';
		...
		$output .= '<div class="dtdr-settings-options-holder">';
			...
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="incharge-plural-label" name="dtdr[label][incharge-plural-label]" type="text" value="'.esc_attr( $incharge_plural_label ).'" />';
